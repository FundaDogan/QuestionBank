...
public class Concatenation {
    ...
    Concatenation: Joining Strings with each other or with other data types.
                   ...
                   2) Use 'concat()' method ==>Inside the concat() parenthesis you can put just String
                   not other data types.
                   But we can put char,int vb inside " " and concatenate.
     */
             ...
             System.out.println(s.concat(",").concat("a").concat(t));
